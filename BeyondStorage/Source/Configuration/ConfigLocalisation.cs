...
{
    internal const string RANGE_SETTING_TOOLTIP_KEY = "bsSettingRangeTooltip";
    internal const string ALLOW_PUSH_TO_ALLIED_VEHICLES_SETTING_TOOLTIP_KEY = "bsSettingAllowPushToAlliedVehiclesToolTip";
