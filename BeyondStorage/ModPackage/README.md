...
The mod can also be configured by editing the `Mods/BeyondStorage3/config.json` file.
...
For mods that use [url=https://www.nexusmods.com/7daystodie/mods/6176]0-SCore[/url], you need to disable these Features:
[list][*]Remote Crafting[/*]
[*]Remote Repair/Upgrade[/*][/list]

#### Farm Life

[list][*]❌Since Farm Life edition for 2.6 of the game, this mod no longer considered compatible, but YMMV[/*]
[*][url=https://www.nexusmods.com/7daystodie/mods/2108]War3zuk FarmLife v2.5 B32 Stable[/url] and v2.5.x of the mod is compatible (also most other versions of this mod and Farm Life should work ok)[/*][/list]

#### Others (not compatible)

[list][*]❌[url=https://www.nexusmods.com/7daystodie/mods/8289]Advanced UI[/url][/*][/list]
